...
**A smart diary application powered by Voice AI** 🎙️✨
...
<div align="center">
  <table>
    ...
    <tr>
      ...
      <td><img src=".github/docs/assets/images/color cambiado.png" alt="AI Color Change" width="200"/></td>
    ...
    <tr>
      ...
      <td align="center"><b>AI Color Change</b></td>
...
- 🎤 **Real-Time Voice Conversations**: Speak naturally with Gemini Live for instant and seamless diary creation
- 🗣️ **Traditional Voice Commands**: Record, transcribe, and process voice commands step-by-step
- 🎨 **AI-Powered Dynamic Themes**: Change your app's appearance simply by asking
- 🖼️ **Automatic Image Generation**: AI creates beautiful illustrations for your entries
- 📊 **Smart Summaries**: Get AI-generated insights on your daily, weekly, or monthly reflections
- 🌐 **Cross-Platform**: Works perfectly on iOS, Android, Web, Windows, macOS, and Linux
...
- **Two-way streaming audio** with Gemini 2.0 Flash Live
- **Sub-millisecond latency** for natural conversations
- **Continuous dialogue** without manual start/stop
- **Function calling** during conversation to execute actions
- Available commands:
...
- Ideal for **slow and deliberate interactions**

#### 3. 🎙️ Voice Note Creation
- **Quick entry creation** by voice
...
<div align="center">
    <sub>Built with ❤️ by the Angular Medellín community and Weincode.</sub><br>
